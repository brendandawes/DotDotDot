...
public class DotDotDotProjection extends PApplet {
...
final int BACKGROUND_COLOR = color(0, 0, 0);
...
public void setup() {
  ...
  rectMode(CENTER);
  RG.init(this);
  H.init(this).background(0xfff9f9f9).autoClear(false);
...
class Project {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--hide-stop", "DotDotDotProjection" };
    if (passedArgs != null) {
